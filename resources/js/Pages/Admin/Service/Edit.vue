<template>
    <div class="flex flex-col gap-10 items-center py-10">
        ...
        <h1 class="text-xl font-bold">تعديل خدمة</h1>
        <form
            dir="rtl"
...
const form = useForm({
    ...
    percent: props.service.percent ?? null,
    mainBarcode: props.service.mainBarcode ?? null,
    mainBarcodeSellprice: props.item.sell_price ?? null,
...
const submit = () => form.put(route("admin.service.update", props.service.id));
</script>
